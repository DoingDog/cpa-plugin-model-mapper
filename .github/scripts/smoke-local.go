...
func run() error {
	...
	cases := []caseConfig{
		...
		{name: "openai-completions-rules-scoped-hit", requestFormat: "openai", rulesField: "openai_completions_rules", requestModel: "client-openai-completions-rules", requestAPIKey: localAPIKey, pluginRules: "local-smoke-*#client-openai-completions-rules=>definitely-not-a-real-upstream-model;client-openai-completions-rules=>deepseek-v4-flash", wantSuccess: false, wantFailureContains: "definitely-not-a-real-upstream-model"},
		{name: "openai-completions-rules-fallback", requestFormat: "openai", rulesField: "openai_completions_rules", requestModel: "client-openai-completions-rules", requestAPIKey: fallbackAPIKey, pluginRules: "local-smoke-*#client-openai-completions-rules=>definitely-not-a-real-upstream-model;client-openai-completions-rules=>deepseek-v4-flash", wantSuccess: true, wantOriginalModel: "client-openai-completions-rules"},
		{name: "claude-messages-rules-scoped-hit", requestFormat: "claude", rulesField: "claude_messages_rules", requestModel: "client-claude-messages-rules", requestAPIKey: localAPIKey, pluginRules: "local-smoke-*#client-claude-messages-rules=>definitely-not-a-real-upstream-model;client-claude-messages-rules=>deepseek-v4-flash", wantSuccess: false, wantFailureContains: "definitely-not-a-real-upstream-model"},
		{name: "claude-messages-rules-fallback", requestFormat: "claude", rulesField: "claude_messages_rules", requestModel: "client-claude-messages-rules", requestAPIKey: fallbackAPIKey, pluginRules: "local-smoke-*#client-claude-messages-rules=>definitely-not-a-real-upstream-model;client-claude-messages-rules=>deepseek-v4-flash", wantSuccess: true, wantOriginalModel: "client-claude-messages-rules"},
